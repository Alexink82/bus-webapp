...
(function() {
  ...
  var messages = {
    ru: {
      ...
      selectRouteAndDate: 'Выберите маршрут и дату',
      ...
      noBookingsHint: 'Здесь появятся ваши поездки',
      statTrips: 'Поездок',
      statSpent: 'Потрачено',
      statNextTrip: 'Следующая поездка',
      today: 'Сегодня',
    ...
    en: {
      ...
      selectRouteAndDate: 'Select route and date',
      ...
      noBookingsHint: 'Your trips will appear here',
      statTrips: 'Trips',
      statSpent: 'Spent',
      statNextTrip: 'Next trip',
      today: 'Today',
    ...
    be: {
      ...
      selectRouteAndDate: 'Выберыце маршрут і дату',
      ...
      error: 'Памылка',
      loading: 'Загрузка...',
      noBookings: 'Пакуль няма заявак',
      noBookingsHint: 'Тут з\'являцца вашы паездкі',
      statTrips: 'Паездак',
      statSpent: 'Выдаткавана',
      statNextTrip: 'Наступная паездка',
      today: 'Сёння',
