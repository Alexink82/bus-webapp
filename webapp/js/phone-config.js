...
(function() {
  ...
  function formatPhoneInputLocal(value, countryCode) {
    ...
    if (c.code === 'RU') return '(' + digits.slice(0, 3) + ') ' + digits.slice(3, 6) + (len > 6 ? '-' + digits.slice(6, 8) : '') + (len > 8 ? '-' + digits.slice(8) : '');
    if (c.code === 'BY') return '(' + digits.slice(0, 2) + ') ' + digits.slice(2, 5) + (len > 5 ? '-' + digits.slice(5, 7) : '') + (len > 7 ? '-' + digits.slice(7) : '');
    if (c.code === 'UA') return '(' + digits.slice(0, 2) + ') ' + digits.slice(2, 5) + (len > 5 ? '-' + digits.slice(5, 7) : '') + (len > 7 ? '-' + digits.slice(7) : '');
    if (c.code === 'PL') return digits.slice(0, 3) + (len > 3 ? ' ' + digits.slice(3, 6) : '') + (len > 6 ? ' ' + digits.slice(6) : '');
    if (c.code === 'LT') return '(' + digits.slice(0, 3) + (len > 3 ? ') ' + digits.slice(3) : ')');
    if (c.code === 'LV') return digits.slice(0, 2) + (len > 2 ? ' ' + digits.slice(2, 5) : '') + (len > 5 ? ' ' + digits.slice(5) : '');
    if (c.code === 'GE') return '(' + digits.slice(0, 3) + ') ' + digits.slice(3, 5) + (len > 5 ? ' ' + digits.slice(5, 7) : '') + (len > 7 ? ' ' + digits.slice(7) : '');
    if (c.code === 'AM') return digits.slice(0, 2) + (len > 2 ? ' ' + digits.slice(2, 5) : '') + (len > 5 ? ' ' + digits.slice(5) : '');
    return digits;
  }
